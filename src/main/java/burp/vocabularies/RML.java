...
public final class RML {
    ...
    public static final Property innerJoin  = ResourceFactory.createProperty(NS + "innerJoin");
    ...
    public static final Property parentLogicalView  = ResourceFactory.createProperty(NS + "parentLogicalView");
